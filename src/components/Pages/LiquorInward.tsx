...
export default function LiquorInward({ displayModal }: LiquorInwardProps) {
  const { data: stockItems, addData: addStock, updateData: updateStock } = useMessData('stockItems');
  ...
  return (
    <div className="p-6 sm:p-8 rounded-xl w-full bg-white shadow-lg">
      <h1 className="text-2xl sm:text-3xl font-bold text-center text-gray-800 mb-6">Liquor Inward</h1>
      <form onSubmit={handleAddItem} className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        <div className="flex flex-col">
          <label htmlFor="liquorName" className="text-sm font-medium mb-1">Name: <span className="text-red-500">*</span></label>
          <input 
            type="text" 
            id="liquorName" 
            value={name} 
        ...
        <div className="flex flex-col">
          <label htmlFor="liquorQuantity" className="text-sm font-medium mb-1">Quantity: <span className="text-red-500">*</span></label>
          <input 
            type="number" 
            id="liquorQuantity" 
            value={quantity} 
        ...
        <div className="flex flex-col">
          <label htmlFor="liquorUnit" className="text-sm font-medium mb-1">Unit: <span className="text-red-500">*</span></label>
          <select 
            id="liquorUnit" 
            value={unit} 
        ...
        <div className="flex flex-col">
          <label htmlFor="liquorUnitPrice" className="text-sm font-medium mb-1">Unit Price (₹): <span className="text-red-500">*</span></label>
          <input 
            type="number" 
            id="liquorUnitPrice" 
            value={unitPrice} 
        ...
        <div className="flex flex-col">
          <label htmlFor="liquorDate" className="text-sm font-medium mb-1">Date:</label>
          <input 
            type="date" 
            id="liquorDate" 
            value={date} 
